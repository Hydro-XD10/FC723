...
class Math:
    ...
    # checks if the input is string if yes will return error with message "The Input Should Be Intger Or Float"
            if isinstance(Num1 , str) or isinstance(Num2, str):
                raise ValueError("The Input Should Be Intger Or Float")
            
            # checks if the input are 0 and 0 if true will return erorr with message "The GCD between 0 and 0 is mathematically undefined"
